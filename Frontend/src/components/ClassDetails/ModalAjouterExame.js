...
const handleFormSubmit = async (event) => {
  ...
  const loadingToastId = toast.loading('We are generating the quiz...', { autoClose: false });
  ...
  try {
    ...
    // Handle the response
    toast.update(loadingToastId, { render: 'Quiz generated successfully!', type: toast.TYPE.SUCCESS, autoClose: true });
      ...
      <div className="modal-dialog" role="document">
        <div className="modal-content">
          ...
          <div className="modal-header">
            <h4 className="modal-title">&nbsp; Create a New Exam</h4>
            <button
              id='closeBtn'
              className="btn-close"
              type="button"
