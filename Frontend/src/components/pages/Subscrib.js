            ...
            <div className="card shadow" style={{"width":"400px"}}>
                <img className="card-img-top" src={classe?.image.url} alt="Card classe" style={{"width":"100%"}}/>
                    <div className="card-body">
                        ...
                        <p className="card-text mt-2 text-capitalize">Professor {classe?.prof.firstname+' '+classe?.prof.lastname}</p>
                        <form onSubmit={handleInscription}>
                            <button  className="btn btn-primary w-100 mt-3" type='submit'>Join Class</button>
                        </form>
                    </div>
            </div>
        </div>):(
            ...
            <div className="col-lg-6">
              <div className="p-5">
                  <div className="text-center">
                      <h4 className="text-dark mb-4 text-capitalize">Sign in to join the class</h4>
                  </div>
