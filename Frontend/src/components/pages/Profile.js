...
import defaultAvatar from '../../image/user_img.png';
...
const Profile = () => {
  ...
  const updatPhotoHandler = (e) => {
    e.preventDefault();
    if(!file) return toast.warning("Please upload your photo");
  ...
  const profile_settings = (e) =>{
    e.preventDefault();
    if (String(firstname).trim() === "") return toast.error("First Name is required");
    if (String(lastname).trim() === "") return toast.error("Last Name is required");
    if (String(email).trim() === "") return toast.error("Email is required");
    if (String(tel).trim() === "") return toast.error("Phone Number is required");
            ...
            <div className="col-12">
              <div className="card mb-3 d-flex bg-light flex-column justify-content-center align-items-center">
                  <div className="card-body bg-light text-center">
                    ...
                    <img src={file ? URL.createObjectURL(file) : (profile?.photo?.url || defaultAvatar)} alt="" className="profile-image" />
                    ...
                    <abbr title="choose profile photo">
                      ...
                      />
                      <button type="submit" className="upload-profile-photo-btn">Change Photo</button>
                    </form>
                  </div>
