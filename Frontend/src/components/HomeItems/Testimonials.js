      ...
      <div className="row">
        <div className="col-lg-8 offset-lg-2">
          <div className="section-heading">
            <h4>Approved By <em>Teachers</em></h4>
                      ...
                      <div className="thumb">
                        <div className="row">
                          ...
                          <div className="col-lg-4 col-sm-4 d-none d-sm-block">
                            <span className="category">English Teacher</span>
                          </div>
                          <div className="col-lg-4 col-sm-4 col-12">
                      ...
                      <div className="thumb">
                        <div className="row">
                          <div className="col-lg-4 col-sm-4 col-12">
                            ...
                            <span className="date">May 01, 2023</span>
                          </div>
                          <div className="col-lg-4 col-sm-4 d-none d-sm-block">
                            <span className="category">Web Development Trainer</span>
                          </div>
                          <div className="col-lg-4 col-sm-4 col-12">
                              <i className="fa fa-star"></i>
                              <i className="fa fa-star"></i>
                      ...
                      <div className="thumb">
                        <div className="row">
                          <div className="col-lg-4 col-sm-4 col-12">
                            ...
                            <span className="date">April 27, 2023</span>
                          </div>
                          <div className="col-lg-4 col-sm-4 d-none d-sm-block">
                            <span className="category">Economics Teacher</span>
                          </div>
                          <div className="col-lg-4 col-sm-4 col-12">
                              <i className="fa fa-star"></i>
                              <i className="fa fa-star"></i>
