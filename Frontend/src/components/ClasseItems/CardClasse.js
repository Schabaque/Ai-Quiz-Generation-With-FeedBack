    ...
    <div className="col-md-4 col-xl-3">
        <div className="card shadow mb-4">
            <div className="d-flex flex-row justify-content-between p-2">
                ...
                <div className="d-flex dropdown">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><button className="dropdown-item" type='button' onClick={()=>{navigator.clipboard.writeText(`http://localhost:3000/Inviter/${props.id}`);     toast.info("Invitation link copied", {position: "top-center",autoClose: 1000,hideProgressBar: true,closeOnClick: true,pauseOnHover: false,draggable: true,progress: undefined,theme: "light",});}}>Copy Invitation Link</button></li>
                        <li><a className="dropdown-item" href="/">Edit</a></li>
                        <li><span className="dropdown-item spn" onClick={deleteClasse}>Delete</span></li>
                    </ul>
                </div>
            </div>
            ...
            <div className="card-body">
                ...
                <a className="btn btn-outline-primary" role="button" href={`/Classes/${props.id}/Students`} onClick={storeIdClasse}>See More</a>
            </div>
        </div>
    </div>
  )
