...
import {Error,Analytics,MainPage ,ResultOffQuizTable,Classes,Profile, LoginSignin,Students,Examens,PasserExamenPage,ResultOffQuiz,EditerExamen,VerifyEmail, Home,Subscrib, ForgotPassword, StudentDashboard, ResetPassword, Topics, Quizzes, TakeQuiz } from './Routes';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/Topics" element={!user || user?.role === "etudiant" ? <Navigate to="/Auth"/> : <Topics/>}/>
        ...
        <Route path='/MainPages' element={<MainPage/>}/>
